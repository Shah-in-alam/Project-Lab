<?php
// This file contains the HTML code for the website footer.
?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                <div class="flex items-center mb-4">
                    <img src="/assets/images/logo.svg" alt="Tatu Logo" class="h-8 w-auto">
                    <span class="ml-2 text-xl font-bold text-white">Tatu</span>
                </div>
                <p class="text-sm text-gray-400 mb-4">
                    Discover amazing tattoo artists and book your next tattoo appointment with our trusted community of professionals.
                </p>
                <!-- Social Media Links -->
            ...
            <div class="col-span-1">
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="/artists" class="text-gray-400 hover:text-white transition-colors">Find Artists</a></li>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="md:flex md:items-center md:justify-between">
                <div class="text-sm text-gray-400">
                    &copy; <?php echo date("Y"); ?> Tatu. All rights reserved.
                </div>
                <div class="mt-4 md:mt-0">
                    <p class="text-sm text-gray-400">
                        Made with ❤️ by DSPS Students
                    </p>
                </div>
            </div>
        </div>
