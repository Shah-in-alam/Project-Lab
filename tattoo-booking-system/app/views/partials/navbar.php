            ...
            <div class="hidden md:flex md:items-center md:ml-6 space-x-2">
                ...
                <?php else: ?>
                    ...
                    <?php elseif ($userRole === 'artist'): ?>
                        <a href="/artist/profile" class="px-4 py-2 rounded-full text-base font-semibold text-white hover:bg-white/20 transition">Profile</a>
                        ...
                        <a href="/artist/subscription" class="px-4 py-2 rounded-full text-base font-semibold text-white hover:bg-white/20 transition">My Subscription</a>
                    <?php endif; ?>
    ...
    <div x-show="mobileMenu" class="md:hidden bg-gradient-to-br from-pink-100 via-purple-100 to-indigo-100 shadow-xl rounded-b-2xl animate-fade-in-up">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <?php else: ?>
                ...
                <?php elseif ($userRole === 'admin'): ?>
                    <a href="/admin/artists" class="block px-4 py-2 rounded-full text-base font-semibold text-pink-700 hover:bg-pink-100 transition">Manage Artists</a>
                    <a href="/admin/users" class="block px-4 py-2 rounded-full text-base font-semibold text-purple-700 hover:bg-purple-100 transition">Manage Users</a>
                <?php elseif ($userRole === 'artist'): ?>
                    <a href="/artist/profile" class="block px-4 py-2 rounded-full text-base font-semibold text-pink-700 hover:bg-pink-100 transition">Profile</a>
                    ...
                    <a href="/artist/subscription" class="block px-4 py-2 rounded-full text-base font-semibold text-yellow-500 hover:bg-yellow-100 transition">My Subscription</a>
                <?php endif; ?>
