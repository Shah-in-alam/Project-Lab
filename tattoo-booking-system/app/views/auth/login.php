...
<body class="min-h-screen h-100 animate-gradient flex flex-col">
            ...
            <div class="flex flex-col gap-3 mb-6">
                <a href="/auth/google" class="flex items-center justify-center gap-3 w-full py-2 rounded-lg bg-white border border-gray-300 shadow hover:bg-gray-50 transition">
                    <svg class="h-6 w-6" viewBox="0 0 48 48">
                        <g>
                            <path fill="#4285F4" d="M24 9.5c3.54 0 6.71 1.22 9.2 3.23l6.9-6.9C36.64 2.7 30.7 0 24 0 14.82 0 6.73 5.4 2.69 13.32l8.06 6.26C12.7 13.09 17.9 9.5 24 9.5z" />
                            <path fill="#34A853" d="M46.1 24.5c0-1.64-.15-3.22-.43-4.74H24v9.04h12.4c-.54 2.9-2.18 5.36-4.64 7.04l7.2 5.6C43.27 37.09 46.1 31.34 46.1 24.5z" />
                            <path fill="#FBBC05" d="M10.75 28.08A14.5 14.5 0 019.5 24c0-1.41.23-2.77.63-4.08l-8.06-6.26A23.93 23.93 0 000 24c0 3.77.9 7.34 2.5 10.44l8.25-6.36z" />
                            <path fill="#EA4335" d="M24 48c6.48 0 11.92-2.15 15.89-5.85l-7.2-5.6c-2.01 1.36-4.58 2.17-8.69 2.17-6.1 0-11.3-3.59-13.25-8.66l-8.25 6.36C6.73 42.6 14.82 48 24 48z" />
                        </g>
                    </svg>
